...
| [`/ashare-data`](skills/ashare-data.md) | A株データパイプライン統一エントリー | 株価/財務/開示/市場シグナルを一括取得し、ソースとデータ時点を明記 |
...
完全レポート：[AI算力](local/reports/AI算力-funnel-20260509.md) · [AIモデル](local/reports/AI模型-funnel-20260509.md) · [AIアプリケーション](local/reports/AI应用-funnel-20260509.md) · [AIインフラ＆電力](local/reports/AI基建电力-funnel-20260509.md)
...
|-----|---------|---------|---------|
| 拼多多（PDD） | `/investment-team` | 総合3.4/5——極めて安いが10年の確実性は不十分；モデレートなポジションに適切 | [レポートを見る](local/reports/拼多多/) |
| テンセント（0700.HK） | `/investment-research` | ソーシャル独占＋優れた資本配分；先行PER14倍は妥当〜低い | [レポートを見る](local/reports/腾讯/) |
| 7社比較 | `/investment-checklist` | 茅台＆テンセントは合格；NVIDIA、美団＆快手は条件付き；拼多多＆泡泡玛特はグレーゾーン | [レポートを見る](local/reports/多公司对比-checklist-20260408.md) |
| 巨人保有銘柄トラッカー | カスタムリサーチ | バフェット / 李録 / 段永平の最新13F保有銘柄＋PDDコスト基準分析 | [レポートを見る](local/reports/大师持仓追踪-research-20260408.md) |
