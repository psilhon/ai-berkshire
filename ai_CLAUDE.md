...
**V3（20个Skill，2026年7月）— 数据管线入口化：**
- 新增：ashare-data（A股数据管线统一入口：行情/财务/估值/年报史/股本变动/公告/市场信号），与 financial-data 规范双向互引
...
- local/reports/ 目录下有一些早期文件命名不规范（中文下划线混合），后续统一为英文短横格式
